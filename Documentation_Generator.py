...
3. **Logic Deep-Dive:** Explain the primary business logic flow. Identify the "Entry Point" file and the "Controller" logic.
4. **Technical Stack:** List the technologies used based on the imports and file extensions found in the skeleton.
